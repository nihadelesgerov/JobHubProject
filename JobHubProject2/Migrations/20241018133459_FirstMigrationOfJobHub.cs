...
{
    /// <inheritdoc />
    public partial class FirstMigrationOfJobHub : Migration
    {
        /// <inheritdoc />
        protected override void Up(MigrationBuilder migrationBuilder)
        {
            ...
            migrationBuilder.CreateTable(
                ...
                columns: table => new
                {
                    ...
                    CompanyFoundedYear = table.Column<string>(type: "nvarchar(max)", nullable: false),
                    ...
                    CompanyHeadOffice = table.Column<string>(type: "nvarchar(max)", nullable: false),
                    ...
                    CompanyMission = table.Column<string>(type: "nvarchar(max)", nullable: false),
                    CompanyVision = table.Column<string>(type: "nvarchar(max)", nullable: false),
                    CompanyLinkedInUrl = table.Column<string>(type: "nvarchar(max)", nullable: false),
                    CompanyTwitterUrl = table.Column<string>(type: "nvarchar(max)", nullable: false),
                    CompanyFacebookUrl = table.Column<string>(type: "nvarchar(max)", nullable: false),
                    CompanyInstagramUrl = table.Column<string>(type: "nvarchar(max)", nullable: false),
                    CompanyIsActive = table.Column<bool>(type: "bit", nullable: false),
                    CompanyIsBanned = table.Column<bool>(type: "bit", nullable: false)
                },
                constraints: table =>
                {
                    table.PrimaryKey("PK_CompanyTable", x => x.Id);
                    table.ForeignKey(
                        name: "FK_CompanyTable_AspNetUsers_UserId",
                        column: x => x.UserId,
                        principalTable: "AspNetUsers",
                        principalColumn: "Id",
                        onDelete: ReferentialAction.Cascade);
            ...
            migrationBuilder.CreateTable(
                ...
                constraints: table =>
                {
                    ...
                    table.ForeignKey(
                        name: "FK_JobTable_CompanyTable_CompanyProfileId",
            ...
            migrationBuilder.CreateIndex(
                name: "IX_JobTable_CompanyProfileId",
                table: "JobTable",
